      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" aria-label="Home">
            <span className={`text-2xl ${logoTextClasses} text-[#bd8869]`}>T<span className="text-[#d0879e]">&</span>T</span>
          </Link>
              ...
              <nav className="flex flex-col space-y-3">
                {routes.map((route) => (
                  <Link
                    key={route.path}
                    to={route.path}
                    className={`text-wedding-charcoal py-2 px-4 rounded-md ${pathname === route.path
